package com.edge.fastestcomperator.comperators;
...
public final class FastestComparator {
    ...
    /**
     * Get an int and com.edge.fastestcomperator.pojo.CustomNumberEntity values as input and compare them as a int numbers
